...
import com.fastandfurious.reindeer.base.ui.view.MainErrorHandler__BeanDefinitions;
import com.fastandfurious.reindeer.taskmanagement.domain.TaskRepository__BeanDefinitions;
import com.fastandfurious.reindeer.taskmanagement.service.TaskService__BeanDefinitions;
import com.fastandfurious.reindeer.taskmanagement.ui.view.TaskListView__BeanDefinitions;
import com.vaadin.flow.spring.SpringBootAutoConfiguration__BeanDefinitions;
import com.vaadin.flow.spring.VaadinApplicationConfiguration__BeanDefinitions;
import com.vaadin.flow.spring.VaadinConfigurationProperties__BeanDefinitions;
import com.vaadin.flow.spring.VaadinScopesConfig__BeanDefinitions;
import com.vaadin.flow.spring.VaadinServletConfiguration__BeanDefinitions;
import com.vaadin.flow.spring.springnative.VaadinBeanFactoryInitializationAotProcessor__BeanDefinitions;
import com.vaadin.hilla.ApplicationContextProvider__BeanDefinitions;
import com.vaadin.hilla.EndpointControllerConfiguration__BeanDefinitions;
import com.vaadin.hilla.EndpointController__BeanDefinitions;
import com.vaadin.hilla.EndpointProperties__BeanDefinitions;
import com.vaadin.hilla.push.PushConfigurer__BeanDefinitions;
import com.vaadin.hilla.route.RouteUnifyingConfiguration__BeanDefinitions;
import com.vaadin.hilla.route.RouteUtil__BeanDefinitions;
import com.vaadin.hilla.signals.config.SignalsConfiguration__BeanDefinitions;
import com.vaadin.hilla.startup.EndpointRegistryInitializer__BeanDefinitions;
import com.vaadin.hilla.startup.RouteUnifyingServiceInitListener__BeanDefinitions;
...
public class Application__BeanFactoryRegistrations {
  ...
  public void registerBeanDefinitions(DefaultListableBeanFactory beanFactory) {
    ...
    beanFactory.registerBeanDefinition("mainErrorHandler", MainErrorHandler__BeanDefinitions.getMainErrorHandlerBeanDefinition());
    beanFactory.registerBeanDefinition("taskService", TaskService__BeanDefinitions.getTaskServiceBeanDefinition());
    beanFactory.registerBeanDefinition("errorHandlerInitializer", MainErrorHandler__BeanDefinitions.getErrorHandlerInitializerBeanDefinition());
    beanFactory.registerBeanDefinition("clock", Application__BeanDefinitions.getClockBeanDefinition());
    ...
    beanFactory.registerBeanDefinition("com.vaadin.flow.spring.VaadinApplicationConfiguration", VaadinApplicationConfiguration__BeanDefinitions.getVaadinApplicationConfigurationBeanDefinition());
    beanFactory.registerBeanDefinition("defaultApplicationConfigurationFactory", VaadinApplicationConfiguration__BeanDefinitions.getDefaultApplicationConfigurationFactoryBeanDefinition());
    beanFactory.registerBeanDefinition("vaadinApplicationContextInitializer", VaadinApplicationConfiguration__BeanDefinitions.getVaadinApplicationContextInitializerBeanDefinition());
    beanFactory.registerBeanDefinition("springSecurityVaadinMenuAccessControl", VaadinApplicationConfiguration__BeanDefinitions.getSpringSecurityVaadinMenuAccessControlBeanDefinition());
    beanFactory.registerBeanDefinition("com.vaadin.flow.spring.VaadinServletConfiguration", VaadinServletConfiguration__BeanDefinitions.getVaadinServletConfigurationBeanDefinition());
    beanFactory.registerBeanDefinition("vaadinRootMapping", VaadinServletConfiguration__BeanDefinitions.getVaadinRootMappingBeanDefinition());
    beanFactory.registerBeanDefinition("vaadinForwardingController", VaadinServletConfiguration__BeanDefinitions.getVaadinForwardingControllerBeanDefinition());
    beanFactory.registerBeanDefinition("com.vaadin.flow.spring.SpringBootAutoConfiguration", SpringBootAutoConfiguration__BeanDefinitions.getSpringBootAutoConfigurationBeanDefinition());
    beanFactory.registerBeanDefinition("contextInitializer", SpringBootAutoConfiguration__BeanDefinitions.getContextInitializerBeanDefinition());
    beanFactory.registerBeanDefinition("servletRegistrationBean", SpringBootAutoConfiguration__BeanDefinitions.getServletRegistrationBeanBeanDefinition());
    beanFactory.registerBeanDefinition("websocketEndpointDeployer", SpringBootAutoConfiguration__BeanDefinitions.getWebsocketEndpointDeployerBeanDefinition());
    beanFactory.registerBeanDefinition("vaadin-com.vaadin.flow.spring.VaadinConfigurationProperties", VaadinConfigurationProperties__BeanDefinitions.getVaadinConfigurationPropertiesBeanDefinition());
    ...
    beanFactory.registerBeanDefinition("com.vaadin.flow.spring.VaadinScopesConfig", VaadinScopesConfig__BeanDefinitions.getVaadinScopesConfigBeanDefinition());
    beanFactory.registerBeanDefinition("vaadinSessionScope", VaadinScopesConfig__BeanDefinitions.getVaadinSessionScopeBeanDefinition());
    beanFactory.registerBeanDefinition("vaadinUIScope", VaadinScopesConfig__BeanDefinitions.getVaadinUIScopeBeanDefinition());
    beanFactory.registerBeanDefinition("vaadinRouteScope", VaadinScopesConfig__BeanDefinitions.getVaadinRouteScopeBeanDefinition());
    beanFactory.registerBeanDefinition("com.vaadin.hilla.ApplicationContextProvider", ApplicationContextProvider__BeanDefinitions.getApplicationContextProviderBeanDefinition());
    beanFactory.registerBeanDefinition("com.vaadin.hilla.EndpointControllerConfiguration", EndpointControllerConfiguration__BeanDefinitions.getEndpointControllerConfigurationBeanDefinition());
    beanFactory.registerBeanDefinition("accessAnnotationChecker", EndpointControllerConfiguration__BeanDefinitions.getAccessAnnotationCheckerBeanDefinition());
    beanFactory.registerBeanDefinition("accessChecker", EndpointControllerConfiguration__BeanDefinitions.getAccessCheckerBeanDefinition());
    beanFactory.registerBeanDefinition("csrfChecker", EndpointControllerConfiguration__BeanDefinitions.getCsrfCheckerBeanDefinition());
    beanFactory.registerBeanDefinition("hillaEndpointObjectMapper", EndpointControllerConfiguration__BeanDefinitions.getHillaEndpointObjectMapperBeanDefinition());
    beanFactory.registerBeanDefinition("endpointInvoker", EndpointControllerConfiguration__BeanDefinitions.getEndpointInvokerBeanDefinition());
    beanFactory.registerBeanDefinition("endpointNameChecker", EndpointControllerConfiguration__BeanDefinitions.getEndpointNameCheckerBeanDefinition());
    beanFactory.registerBeanDefinition("endpointRegistry", EndpointControllerConfiguration__BeanDefinitions.getEndpointRegistryBeanDefinition());
    beanFactory.registerBeanDefinition("endpointUtil", EndpointControllerConfiguration__BeanDefinitions.getEndpointUtilBeanDefinition());
    beanFactory.registerBeanDefinition("typeChecker", EndpointControllerConfiguration__BeanDefinitions.getTypeCheckerBeanDefinition());
    beanFactory.registerBeanDefinition("webMvcRegistrationsHandlerMapping", EndpointControllerConfiguration__BeanDefinitions.getWebMvcRegistrationsHandlerMappingBeanDefinition());
    beanFactory.registerBeanDefinition("endpointCodeGenerator", EndpointControllerConfiguration__BeanDefinitions.getEndpointCodeGeneratorBeanDefinition());
    beanFactory.registerBeanDefinition("com.vaadin.hilla.EndpointProperties", EndpointProperties__BeanDefinitions.getEndpointPropertiesBeanDefinition());
    beanFactory.registerBeanDefinition("com.vaadin.hilla.EndpointController", EndpointController__BeanDefinitions.getEndpointControllerBeanDefinition());
    beanFactory.registerBeanDefinition("com.vaadin.hilla.push.PushConfigurer", PushConfigurer__BeanDefinitions.getPushConfigurerBeanDefinition());
    beanFactory.registerBeanDefinition("pushEndpoint", PushConfigurer__BeanDefinitions.getPushEndpointBeanDefinition());
    beanFactory.registerBeanDefinition("pushMessageHandler", PushConfigurer__BeanDefinitions.getPushMessageHandlerBeanDefinition());
    beanFactory.registerBeanDefinition("atmosphereInitializer", PushConfigurer__BeanDefinitions.getAtmosphereInitializerBeanDefinition());
    beanFactory.registerBeanDefinition("atmosphereServlet", PushConfigurer__BeanDefinitions.getAtmosphereServletBeanDefinition());
    beanFactory.registerBeanDefinition("com.vaadin.hilla.route.RouteUnifyingConfiguration", RouteUnifyingConfiguration__BeanDefinitions.getRouteUnifyingConfigurationBeanDefinition());
    beanFactory.registerBeanDefinition("routeUnifyingConfigurationProperties", RouteUnifyingConfiguration__BeanDefinitions.getRouteUnifyingConfigurationPropertiesBeanDefinition());
    beanFactory.registerBeanDefinition("com.vaadin.hilla.route.RouteUtil", RouteUtil__BeanDefinitions.getRouteUtilBeanDefinition());
    beanFactory.registerBeanDefinition("com.vaadin.hilla.signals.config.SignalsConfiguration", SignalsConfiguration__BeanDefinitions.getSignalsConfigurationBeanDefinition());
    beanFactory.registerBeanDefinition("signalsHandler", SignalsConfiguration__BeanDefinitions.getSignalsHandlerBeanDefinition());
    beanFactory.registerBeanDefinition("com.vaadin.hilla.startup.EndpointRegistryInitializer", EndpointRegistryInitializer__BeanDefinitions.getEndpointRegistryInitializerBeanDefinition());
    beanFactory.registerBeanDefinition("com.vaadin.hilla.startup.RouteUnifyingServiceInitListener", RouteUnifyingServiceInitListener__BeanDefinitions.getRouteUnifyingServiceInitListenerBeanDefinition());
    ...
    beanFactory.registerBeanDefinition("jpa.TaskRepository.fragments#0", RepositoryComposition__BeanDefinitions.RepositoryFragments.getFragmentsBeanDefinition());
    ...
    beanFactory.registerBeanDefinition("com.fastandfurious.reindeer.taskmanagement.ui.view.TaskListView", TaskListView__BeanDefinitions.getTaskListViewBeanDefinition());
    beanFactory.registerBeanDefinition("com.vaadin.flow.spring.springnative.VaadinBeanFactoryInitializationAotProcessor$Marker", VaadinBeanFactoryInitializationAotProcessor__BeanDefinitions.Marker.getMarkerBeanDefinition());
  }
