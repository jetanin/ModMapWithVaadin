...
// node_modules/@vaadin/field-highlighter/src/vaadin-field-highlighter-styles.js
...
var UserTag = class extends ThemableMixin(DirMixin(PolylitMixin(LitElement))) {
  static get is() {
...
var UserTagsOverlay = class extends PositionMixin(OverlayMixin(DirMixin(ThemableMixin(PolylitMixin(LitElement))))) {
  static get is() {
...
var FieldOutline = class extends ThemableMixin(DirMixin(PolylitMixin(LitElement))) {
  static get is() {
...
@vaadin/field-highlighter/src/vaadin-field-highlighter-styles.js:
  (**
   * @license
   * Copyright (c) 2021 - 2025 Vaadin Ltd.
   * This program is available under Apache License Version 2.0, available at https://vaadin.com/license/
