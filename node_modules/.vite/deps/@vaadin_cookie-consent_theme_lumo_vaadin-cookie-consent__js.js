...
var CookieConsentMixin = (superClass) => class CookieConsentMixinClass extends superClass {
...
var CookieConsent = class extends CookieConsentMixin(ElementMixin(PolymerElement)) {
  static get template() {
    return html`
      <style>
        :host {
...
@vaadin/cookie-consent/src/vaadin-cookie-consent-mixin.js:
  (**
   * @license
...
@vaadin/cookie-consent/src/vaadin-cookie-consent.js:
  (**
   * @license
   * Copyright (c) 2000 - 2025 Vaadin Ltd.
   *
   ...
   *)
*/
//# sourceMappingURL=@vaadin_cookie-consent_theme_lumo_vaadin-cookie-consent__js.js.map
