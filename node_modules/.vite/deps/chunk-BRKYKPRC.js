...
var TabMixin = (superClass) => class TabMixinClass extends ItemMixin(superClass) {
  /** @protected */
  ready() {
    super.ready();
...
var Tab = class extends ElementMixin(ThemableMixin(TabMixin(ControllerMixin(PolymerElement)))) {
  static get template() {
    return html`
      <slot></slot>
...
@vaadin/tabs/src/vaadin-tab-mixin.js:
  (**
   * @license
...
@vaadin/tabs/src/vaadin-tab-styles.js:
  (**
   * @license
   * Copyright (c) 2017 - 2025 Vaadin Ltd.
   * This program is available under Apache License Version 2.0, available at https://vaadin.com/license/
...
@vaadin/tabs/src/vaadin-tab.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-BRKYKPRC.js.map
