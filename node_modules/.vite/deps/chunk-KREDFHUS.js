...
// node_modules/@vaadin/icon/src/vaadin-icon-styles.js
var iconStyles = css`
  :host {
    display: inline-flex;
...
var Icon = class extends IconMixin(ControllerMixin(ElementMixin(ThemableMixin(PolymerElement)))) {
  static get template() {
    return html`
      <svg
        version="1.1"
...
@vaadin/icon/src/vaadin-icon-mixin.js:
  (**
   * @license
   * Copyright (c) 2021 - 2025 Vaadin Ltd.
   * This program is available under Apache License Version 2.0, available at https://vaadin.com/license/
...
@vaadin/icon/src/vaadin-icon-styles.js:
  (**
   * @license
...
@vaadin/icon/src/vaadin-icon.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-KREDFHUS.js.map
