...
var BoardRowMixin = (superClass) => class BoardRowMixinClass extends ResizeMixin(superClass) {
  constructor() {
    super();
    this._oldWidth = 0;
...
var BoardRow = class extends BoardRowMixin(ElementMixin(PolymerElement)) {
  static get template() {
    return html`
      <style>
        :host {
...
@vaadin/board/src/vaadin-board-row-mixin.js:
  (**
   * @license
...
@vaadin/board/src/vaadin-board-row.js:
  (**
   * @license
   * Copyright (c) 2000 - 2025 Vaadin Ltd.
   *
   ...
   *)
*/
//# sourceMappingURL=chunk-O6PE37UW.js.map
