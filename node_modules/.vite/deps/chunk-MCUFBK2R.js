...
import {
  LabelController
} from "./chunk-SX3OERDA.js";
import {
  setAriaIDReference
} from "./chunk-3U65M3F2.js";
import {
  ItemMixin
...
var SelectOverlay = class extends SelectOverlayMixin(ThemableMixin(PolymerElement)) {
  static get is() {
  ...
  _assignMenuElement(menuElement) {
    if (menuElement && menuElement !== this.__lastMenuElement) {
      ...
      menuElement.addEventListener(
        "click",
        (e) => {
          const item2 = e.composedPath().find((el) => el._hasVaadinItemMixin);
...
@vaadin/select/theme/lumo/vaadin-select.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-MCUFBK2R.js.map
