...
import {
  ComboBoxPlaceholder
} from "./chunk-35ABV7OQ.js";
import {
  InputControlMixin,
  inputFieldShared as inputFieldShared2
} from "./chunk-O5PO3KBB.js";
import {
  inputFieldShared
} from "./chunk-HKTMLLWR.js";
import {
  InputContainer
} from "./chunk-3C2DXTKX.js";
import {
  fieldButton
...
// node_modules/@vaadin/multi-select-combo-box/src/vaadin-multi-select-combo-box-styles.js
...
`;
var multiSelectComboBoxChip = css`
  :host {
    display: inline-flex;
    align-items: center;
    align-self: center;
...
var multiSelectComboBoxOverlayStyles = css`
  #overlay {
    width: var(
...
var MultiSelectComboBoxOverlay = class extends ComboBoxOverlayMixin(OverlayMixin(DirMixin(ThemableMixin(PolymerElement)))) {
  static get is() {
...
var MultiSelectComboBoxInternalMixin = (superClass) => class MultiSelectComboBoxInternalMixinClass extends ComboBoxDataProviderMixin(ComboBoxMixin(superClass)) {
  static get properties() {
    return {
      /**
...
var MultiSelectComboBoxInternal = class extends MultiSelectComboBoxInternalMixin(ThemableMixin(PolymerElement)) {
  static get is() {
...
var MultiSelectComboBoxMixin = (superClass) => class MultiSelectComboBoxMixinClass extends InputControlMixin(ResizeMixin(superClass)) {
  static get properties() {
    return {
      /**
...
var MultiSelectComboBox = class extends MultiSelectComboBoxMixin(ThemableMixin(ElementMixin(PolymerElement))) {
  static get is() {
    return "vaadin-multi-select-combo-box";
  }
  static get template() {
...
@vaadin/multi-select-combo-box/src/vaadin-multi-select-combo-box-styles.js:
  (**
   * @license
   * Copyright (c) 2021 - 2025 Vaadin Ltd.
   * This program is available under Apache License Version 2.0, available at https://vaadin.com/license/
...
@vaadin/multi-select-combo-box/src/vaadin-multi-select-combo-box-internal-mixin.js:
  (**
   * @license
   * Copyright (c) 2021 - 2025 Vaadin Ltd.
   * This program is available under Apache License Version 2.0, available at https://vaadin.com/license/
...
@vaadin/multi-select-combo-box/theme/lumo/vaadin-multi-select-combo-box.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-IVUSXAMA.js.map
