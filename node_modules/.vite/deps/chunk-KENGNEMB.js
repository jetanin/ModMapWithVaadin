...
var _endpointInfos, _nextId, _onCompleteCallbacks, _onErrorCallbacks, _onNextCallbacks, _onStateChangeCallbacks, _statusOfSubscriptions, _pendingMessages, _socket, _FluxConnection_instances, resubscribeIfWasClosed_fn, connectWebsocket_fn, setSubscriptionConnState_fn, handleMessage_fn, removeSubscription_fn, send_fn, sendPendingMessages_fn;
var FluxConnection = class extends EventTarget {
  constructor(connectPrefix, atmosphereOptions) {
    ...
    __publicField(this, "state", State.INACTIVE);
    __publicField(this, "wasClosed", false);
    ...
    __privateAdd(this, _onStateChangeCallbacks, /* @__PURE__ */ new Map());
    __privateAdd(this, _statusOfSubscriptions, /* @__PURE__ */ new Map());
  ...
  */
  subscribe(endpointName, methodName, parameters) {
    ...
    __privateGet(this, _endpointInfos).set(id, {
      endpointName,
      methodName,
      params
    });
    __privateMethod(this, _FluxConnection_instances, setSubscriptionConnState_fn).call(this, id, FluxSubscriptionState.CONNECTING);
    const hillaSubscription = {
      ...
      onConnectionStateChange: (callback) => {
        __privateGet(this, _onStateChangeCallbacks).set(id, callback);
        callback(new CustomEvent("subscription-state-change", { detail: { state: __privateGet(this, _statusOfSubscriptions).get(id) } }));
        return hillaSubscription;
      }
    };
    return hillaSubscription;
...
_onStateChangeCallbacks = new WeakMap();
_statusOfSubscriptions = new WeakMap();
_pendingMessages = new WeakMap();
_socket = new WeakMap();
_FluxConnection_instances = new WeakSet();
resubscribeIfWasClosed_fn = function() {
  if (this.wasClosed) {
    this.wasClosed = false;
    const toBeRemoved = [];
    __privateGet(this, _endpointInfos).forEach((endpointInfo, id) => {
      var _a3;
      if (((_a3 = endpointInfo.reconnect) == null ? void 0 : _a3.call(endpointInfo)) === ActionOnLostSubscription.RESUBSCRIBE) {
        __privateMethod(this, _FluxConnection_instances, setSubscriptionConnState_fn).call(this, id, FluxSubscriptionState.CONNECTING);
...
connectWebsocket_fn = function(prefix, atmosphereOptions) {
  ...
  __privateSet(this, _socket, (_b = (_a3 = import_atmosphere.default).subscribe) == null ? void 0 : _b.call(_a3, {
    ...
    onOpen: () => {
      if (this.state !== State.ACTIVE) {
        __privateMethod(this, _FluxConnection_instances, resubscribeIfWasClosed_fn).call(this);
    ...
    onReconnect: () => {
      if (this.state !== State.RECONNECTING) {
        ...
        __privateGet(this, _endpointInfos).forEach((_, id) => {
          __privateMethod(this, _FluxConnection_instances, setSubscriptionConnState_fn).call(this, id, FluxSubscriptionState.CONNECTING);
        });
      }
    },
    onFailureToReconnect: () => {
      if (this.state !== State.INACTIVE) {
        this.state = State.INACTIVE;
        this.dispatchEvent(new CustomEvent("state-changed", { detail: { active: false } }));
        __privateGet(this, _endpointInfos).forEach((_, id) => __privateMethod(this, _FluxConnection_instances, setSubscriptionConnState_fn).call(this, id, FluxSubscriptionState.CLOSED));
      }
    },
    ...atmosphereOptions
  }));
};
setSubscriptionConnState_fn = function(id, state) {
  var _a3, _b;
  const currentState = __privateGet(this, _statusOfSubscriptions).get(id);
  if (!currentState) {
    __privateGet(this, _statusOfSubscriptions).set(id, state);
    (_a3 = __privateGet(this, _onStateChangeCallbacks).get(id)) == null ? void 0 : _a3(new CustomEvent("subscription-state-change", { detail: { state: __privateGet(this, _statusOfSubscriptions).get(id) } }));
  } else if (currentState !== state) {
    __privateGet(this, _statusOfSubscriptions).set(id, state);
    (_b = __privateGet(this, _onStateChangeCallbacks).get(id)) == null ? void 0 : _b(new CustomEvent("subscription-state-change", { detail: { state: __privateGet(this, _statusOfSubscriptions).get(id) } }));
  }
};
handleMessage_fn = function(message) {
  ...
  if (isClientMessage(message)) {
    ...
    if (message["@type"] === "update") {
      ...
      __privateMethod(this, _FluxConnection_instances, setSubscriptionConnState_fn).call(this, id, FluxSubscriptionState.CONNECTED);
    } else if (message["@type"] === "complete") {
      (_a3 = __privateGet(this, _onCompleteCallbacks).get(id)) == null ? void 0 : _a3();
      __privateMethod(this, _FluxConnection_instances, removeSubscription_fn).call(this, id);
    } else {
...
removeSubscription_fn = function(id) {
  __privateMethod(this, _FluxConnection_instances, setSubscriptionConnState_fn).call(this, id, FluxSubscriptionState.CLOSED);
  __privateGet(this, _statusOfSubscriptions).delete(id);
  __privateGet(this, _onStateChangeCallbacks).delete(id);
...
send_fn = function(message) {
  ...
  if (this.state === State.INACTIVE) {
    ...
    (_b = (_a3 = __privateGet(this, _socket)) == null ? void 0 : _a3.push) == null ? void 0 : _b.call(_a3, JSON.stringify(message));
  }
};
...
var BODY_PART_NAME = "hilla_body_part";
...
function isFlowLoaded() {
  var _a3, _b, _c;
  return ((_c = (_b = (_a3 = $wnd.Vaadin) == null ? void 0 : _a3.Flow) == null ? void 0 : _b.clients) == null ? void 0 : _c.TypeScript) !== void 0;
}
...
var ConnectClient = class {
  ...
  constructor(options = {}) {
    ...
    */
    ...
    addEventListener("online", () => {
      var _a3;
      if (!isFlowLoaded() && ((_a3 = $wnd.Vaadin) == null ? void 0 : _a3.connectionState)) {
  ...
  */
  async call(endpoint, method, params, init2) {
    ...
    if (files.size > 0) {
      body = new FormData();
      body.append(BODY_PART_NAME, JSON.stringify(paramsWithoutFiles, (_, value) => value === void 0 ? null : value));
    ...
    async function fetchNext(context) {
      var _a3;
      const connectionState = (init2 == null ? void 0 : init2.mute) ? void 0 : (_a3 = $wnd.Vaadin) == null ? void 0 : _a3.connectionState;
      connectionState == null ? void 0 : connectionState.loadingStarted();
      try {
        const response = await fetch(context.request, { signal: init2 == null ? void 0 : init2.signal });
        connectionState == null ? void 0 : connectionState.loadingFinished();
        return response;
      } catch (error) {
        if (error instanceof Error && error.name === "AbortError") {
          connectionState == null ? void 0 : connectionState.loadingFinished();
        } else {
          connectionState == null ? void 0 : connectionState.loadingFailed();
        }
        throw error;
      }
    }
...
*/
//# sourceMappingURL=chunk-KENGNEMB.js.map
