...
} from "./chunk-33XTDONV.js";
import {
  FormatType_default,
  RBush_default,
  VectorEventType_default,
  Vector_default as Vector_default2
} from "./chunk-23R2BRXN.js";
...
import {
  ...
  targetNotEditable,
  zoomByDelta
} from "./chunk-AN6JJVGV.js";
import {
  Vector_default,
  lineStringLength
} from "./chunk-2H5FKCHF.js";
import {
  douglasPeucker,
  douglasPeuckerArray,
  inflateCoordinates,
  ...
  quantizeMultiArray
} from "./chunk-2LAQCL7T.js";
import {
  GeometryLayout_default,
  SimpleGeometry_default,
  rotate as rotate2,
  translate
} from "./chunk-W3EXMIKX.js";
import {
  shared
} from "./chunk-I6FZWPXU.js";
import {
  checkedFonts,
  createEditingStyle
} from "./chunk-KWVFWMN3.js";
import "./chunk-HUAB53OA.js";
import "./chunk-OOQ4RQYW.js";
import "./chunk-DXELRKAD.js";
import "./chunk-MD4QWTTZ.js";
import {
  ViewHint_default
} from "./chunk-UTPQ75UJ.js";
import {
  CLASS_COLLAPSED,
  CLASS_CONTROL,
  CLASS_HIDDEN,
...
import {
  ...
  Layer_default,
  inView
} from "./chunk-JZCIYWQY.js";
import {
  apply,
  compose,
  create,
  makeInverse
} from "./chunk-EK7FU4HO.js";
import "./chunk-HNYO7DLG.js";
import "./chunk-N4Z6MAHQ.js";
import {
  TileState_default
} from "./chunk-LPGIYNCQ.js";
import {
  easeOut
} from "./chunk-DAW5Z6GJ.js";
import {
  hasArea
} from "./chunk-ALXIDXBV.js";
import "./chunk-EB4KOLG6.js";
import "./chunk-PJOXVLHQ.js";
import {
  outerHeight,
  outerWidth,
  removeChildren,
  ...
  replaceChildren,
  replaceNode
} from "./chunk-ORCR4Q2Z.js";
import {
  State_default
} from "./chunk-KQCOT5N3.js";
import {
  DEVICE_PIXEL_RATIO,
  FIREFOX,
  PASSIVE_EVENT_LISTENERS
} from "./chunk-NSKMGQ23.js";
import {
  METERS_PER_UNIT,
  Units_default,
  closestOnCircle,
...
import {
  ...
  isEmpty,
  scaleFromCenter
} from "./chunk-YMRT6NDA.js";
import {
  GeometryType_default,
  clamp,
  lerp,
  squaredDistance
} from "./chunk-LFUZTUSP.js";
import {
  Feature_default
} from "./chunk-LAG6ZY55.js";
import {
  assert
} from "./chunk-UBJGFXUM.js";
import {
  CollectionEventType_default,
  Collection_default
} from "./chunk-V5CNU4Q7.js";
import {
  Disposable_default,
  EventType_default,
  Event_default,
...
var GroupEvent = (
  /** @class */
  function(_super) {
    __extends10(GroupEvent2, _super);
...
var LayerGroup = (
  /** @class */
  function(_super) {
    __extends10(LayerGroup2, _super);
...
var MapBrowserEvent = (
  /** @class */
  function(_super) {
    __extends12(MapBrowserEvent2, _super);
...
var MapBrowserEventHandler = (
  /** @class */
  function(_super) {
    __extends13(MapBrowserEventHandler2, _super);
...
var PluggableMap = (
  /** @class */
  function(_super) {
    __extends15(PluggableMap2, _super);
...
var ScaleLine = (
  ...
  function(_super) {
    ...
    ScaleLine2.prototype.updateElement_ = function() {
      ...
      var html2;
      if (this.scaleBar_) {
        html2 = this.createScaleBar(width, count, suffix);
      } else {
        html2 = count.toFixed(decimalCount < 0 ? -decimalCount : 0) + " " + suffix;
      }
    ...
    ScaleLine2.prototype.createScaleBar = function(width, scale2, suffix) {
      ...
      for (var i = 0; i < this.scaleBarSteps_; i++) {
        ...
        (i % 2 === 0 || this.scaleBarSteps_ === 2 ? this.createStepText(i, width, false, scale2, suffix) : "") + "</div>");
        if (i === this.scaleBarSteps_ - 1) {
          {
          }
          scaleSteps.push(this.createStepText(i + 1, width, true, scale2, suffix));
        }
    ...
    ScaleLine2.prototype.createStepText = function(i, width, isLast, scale2, suffix) {
      var length = i === 0 ? 0 : Math.round(scale2 / this.scaleBarSteps_ * i * 100) / 100;
...
var LineString = (
  /** @class */
  function(_super) {
    __extends34(LineString2, _super);
...
var MultiLineString = (
  /** @class */
  function(_super) {
    __extends35(MultiLineString2, _super);
...
var MultiPoint = (
  /** @class */
  function(_super) {
    __extends36(MultiPoint2, _super);
...
var MultiPolygon = (
  /** @class */
  function(_super) {
    __extends37(MultiPolygon2, _super);
...
var ExtentEvent = (
  /** @class */
  function(_super) {
    __extends39(ExtentEvent2, _super);
...
var ModifyEvent = (
  /** @class */
  function(_super) {
    __extends40(ModifyEvent2, _super);
...
var SelectEvent = (
  /** @class */
  function(_super) {
    __extends41(SelectEvent2, _super);
...
var Map = (
  ...
  function(_super) {
    ...
    Map3.prototype.createRenderer = function() {
      return new Composite_default(this);
    };
    return Map3;
  }(PluggableMap_default)
...
var MapMixin = (superClass) => class extends FocusMixin(ResizeMixin(superClass)) {
  constructor() {
    super();
    ...
    const options = {
      ...
      interactions: defaults2({ onFocusOnly: false }),
      target: this._mapTarget
    };
    this._configuration = new Map_default2(options);
  }
  /**
...
var Map2 = class extends MapMixin(ThemableMixin(ElementMixin(PolymerElement))) {
  static get is() {
    return "vaadin-map";
  }
  static get cvdlName() {
...
defineCustomElement(Map2);
/*! Bundled license information:

@vaadin/map/theme/lumo/vaadin-map-styles.js:
  (**
   * @license
...
@vaadin/map/src/vaadin-map-mixin.js:
  (**
   * @license
   * Copyright (c) 2000 - 2025 Vaadin Ltd.
   *
...
@vaadin/map/src/vaadin-map-styles.js:
  (**
   * @license
   * Copyright (c) 2000 - 2025 Vaadin Ltd.
   *
...
@vaadin/map/theme/lumo/vaadin-map.js:
   ...
   *)
*/
//# sourceMappingURL=@vaadin_map_theme_lumo_vaadin-map__js.js.map
