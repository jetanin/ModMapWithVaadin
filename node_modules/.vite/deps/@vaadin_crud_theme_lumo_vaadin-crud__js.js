import "./chunk-N2FJZISS.js";
import "./chunk-XMXTBDTW.js";
import "./chunk-7KKEUK2K.js";
import "./chunk-NKBMA4ET.js";
import "./chunk-S5QLJC4T.js";
import "./chunk-SRUUEUF4.js";
import "./chunk-QHHEQP53.js";
import "./chunk-BF7H2OG5.js";
import {
  Grid
} from "./chunk-MTT3DP2X.js";
import "./chunk-L6EXTAJV.js";
import {
  FormLayout
} from "./chunk-QPBNJHP7.js";
...
// node_modules/@vaadin/crud/src/vaadin-crud-styles.js
var crudStyles = css`
  :host {
    width: 100%;
    height: 400px;
...
`;
var crudDialogOverlayStyles = css`
  [part='overlay'] {
    max-width: 54em;
    min-width: 20em;
  }
...
registerStyles(
  "vaadin-crud-dialog-overlay",
  [overlayStyles, dialogOverlay2, resizableOverlay, crudDialogOverlayStyles],
  {
...
var Crud = class extends CrudMixin(ControllerMixin(ElementMixin(ThemableMixin(PolymerElement)))) {
  static get template() {
    return html`
      <div id="container">
        <div id="main">
...
@vaadin/crud/src/vaadin-crud-styles.js:
  (**
   * @license
...
@vaadin/crud/src/vaadin-crud-grid-mixin.js:
  (**
   * @license
   * Copyright (c) 2000 - 2025 Vaadin Ltd.
   *
...
@vaadin/crud/src/vaadin-crud-mixin.js:
  (**
   * @license
   * Copyright (c) 2000 - 2025 Vaadin Ltd.
   *
